        ...
        <footer className="footer-distributed">
            <div className="footer-left">
                ...
                <p className="footer-links">
					<a href={'https://github.com/Vainres/Disaster-forecast'} className="link-1">Home</a>
            ...
            <div className="footer-center">
				...
				<div>
					...
					<p><span>KTX Khu B</span> Dĩ An, Bình Dương</p>
				</div>
				...
				<div>
					...
					<p><a href={"mailto:19521898@gm.uit.edu.vn"}>19521898@gm.uit.edu.vn</a></p>
				</div>
